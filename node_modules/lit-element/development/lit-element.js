...
(window['litElementVersions'] || (window['litElementVersions'] = [])).push('3.0.0-pre.2');
/**
...
export class LitElement extends ReactiveElement {
    constructor() {
        super(...arguments);
        this._$renderOptions = { host: this };
    ...
    createRenderRoot() {
        ...
        // the shadowRoot.
        (_a = this._$renderOptions).renderBefore ?? (_a.renderBefore = renderRoot.firstChild);
        return renderRoot;
    }
    /**
