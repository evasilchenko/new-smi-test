 ...
 */
import { html, LitElement, UpdatingElement, ReactiveElement, } from '../lit-element.js';
import { directive, DisconnectableDirective, } from 'lit-html/disconnectable-directive.js';
...
(canTestLitElement ? suite : suite.skip)('LitElement', () => {
    ...
    suite('disconnection handling', () => {
        let host;
        const log = [];
        const d = directive(class extends DisconnectableDirective {
            render(id) {
                log.push(`render-${id}`);
                return (this.id = id);
            }
