 ...
 */
import { _$private, } from './lit-html.js';
 ...
 */
export const isDirectiveResult = (value, klass) => klass === undefined
    ? value?._$litDirective$ !== undefined
    : value?._$litDirective$ === klass;
/**
...
export const insertPart = (containerPart, refPart, part) => {
    ...
    if (part === undefined) {
        ...
        part = new ChildPartImpl(startNode, endNode, containerPart, containerPart.options);
    }
    else {
 ...
 * @param value
 */
export const setComittedValue = (part, value = RESET_VALUE) => (part._$committedValue = value);
/**
 ...
 * @param part
 */
export const getComittedValue = (part) => part._$committedValue;
/**
