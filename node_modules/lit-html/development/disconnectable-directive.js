...
const setChildrenConnected = (parent, isConnected) => {
    ...
    for (const obj of children) {
        ...
        obj._$setDirectiveConnected?.(isConnected, false);
...
const installDisconnectAPI = (obj) => {
    ...
    if (obj.type == PartType.CHILD) {
        (_a = obj)._$setChildPartConnected ?? (_a._$setChildPartConnected = setChildPartConnected);
    }
};
/**
 ...
 * reconnection.
 */
export class DisconnectableDirective extends Directive {
    constructor(partInfo) {
        ...
        // disconnection
        for (let current = this, parent; (parent = current._$parent); current = parent) {
    ...
    _resolve(props) {
        if (!this.isConnected) {
            throw new Error(`DisconnectableDirective ${this.constructor.name} was ` +
