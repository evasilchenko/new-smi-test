...
(_a = globalThis)['litHtmlPlatformSupport'] ?? (_a['litHtmlPlatformSupport'] = (Template, ChildPart) => {
    ...
    childPartProto._$setValue = function (value) {
        ...
        if (container instanceof ShadowRoot && needsPrepareStyles(scope)) {
            ...
            const template = value?._$litType$
                ? this._$committedValue._$template
                    ._$element
     ...
     * by element name.
     */
    childPartProto._$getTemplate = function (strings, result) {
        const scope = this.options.scope;
        ...
        if (template === undefined) {
            templateCache.set(strings, (template = new ShadyTemplate(result, this.options)));
        }
        return template;
    };
});
